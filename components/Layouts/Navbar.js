...
import Shopify from '../technologies/shopify';
                            ...
                            <nav className="navbar navbar-expand-md navbar-light">
                                <Link href="/">
                                    <a className="navbar-brand">
                                       <h2 className="logoname">Mojitolabs</h2>
                                       {/*
                                        <img src={require("../../images/favicon.png")} className="white-logo" alt="logo" />
                                       */}
                                    </a>
                                </Link>
                            ...
                            */}
                                        <li className="nav-item">
                                            ...
                                            <ul className="dropdown-menu">
                                                ...
                                                <li className="nav-item">
                                                    <Link href="/webdevelopment" activeClassName="active">
                                                ...
                                                <li className="nav-item">
                                                    <Link href="/php" activeClassName="active">
                                                        <a className="nav-link">PHP</a>
                                                    </Link>
                                                </li>

                                                <li className="nav-item">
                                                    <Link href="/magento" activeClassName="active">
                                                        <a className="nav-link">Magento</a>
                                                    </Link>
                                                </li>
 
                                                <li className="nav-item">
                                                    <Link href="/wordpress" activeClassName="active">
                                                        <a className="nav-link">Wordpress</a>
                                                    </Link>
                                                </li>

                                                <li className="nav-item">
                                                    <Link href="/webdesigin" activeClassName="active">
                                                        <a className="nav-link">Web desigin</a>
                                                    </Link>
                                                </li>
                                            </ul>
                                        </li>
